...
function TemperatureCheckerSolution() {
  ...
  return (
    <section style={{ fontFamily: 'sans-serif', textAlign: 'center', padding: 16 }}>
      ...
      {temp >= 35 && <p role="alert" style={{ color: '#b91c1c' }}>Heat advisory: stay hydrated!</p>}
      {temp <= 5 && <p role="alert" style={{ color: '#0c4a6e' }}>Freezing warning: stay warm!</p>}
    </section>
  );
}

export default TemperatureCheckerSolution;
